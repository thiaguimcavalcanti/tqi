...
public enum EnumMessages {
	...
	ERRO_GENERIC (FacesMessage.SEVERITY_FATAL, "error.20"),
	ERRO_DUPLICATE_SAVE (FacesMessage.SEVERITY_FATAL, "error.83"),
	
	// INFOS
	INFO_NENHUMA_INFORMACAO_ENCONTRADA_DO_LINK (FacesMessage.SEVERITY_WARN, "info.1"),
	
	// SUCESSOS
	SUCESSO_CONTENTCONTROLLER_VOTE (FacesMessage.SEVERITY_INFO, "success.1"),
